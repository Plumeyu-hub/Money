...
public class AccountInformationActivity extends Activity {
            ...
            public void onClick(View arg0) {
                ...
                if ((mAccountInformationSymbolTv.getText().toString()).equals("-")) {
                    ...
                    if (num > 0) {
                        ...
                        AccountBean updata = new AccountBean(mCategory, mMoney,
    ...
    public void getData() {
        ...
        if (i != null) {
            ...
            mCategory = mAccountBean.getCategory();
            mAccountInformationSymbolTv.setText(mAccountBean.getMoney().substring(0, 1));
            mAccountInformationMoneyEdit.setText(mAccountBean.getMoney().substring(1));
            mAccountInformationMoneyEdit.setSelection(mAccountInformationMoneyEdit.length());
            maccountInformationDaytimeEdit.setText(mAccountBean.getDaytime());
            String sd_account = mAccountBean.getAccount();
